...
<template>
  <panel v-for="user in workers" class="overflow-hidden group lg:scale-100 lg:hover:scale-105 transition">
    <router-link :to="{ name: 'profile', params: { userId: user._id } }">
      <div class="p-2 xs:p-4 flex gap-2.5 xs:gap-3.5 md:gap-4 lg:gap-5 xl:gap-6 items-center transition" :class="[ user.verify ? 'bg-blue-500/20 dark:bg-blue-500/10 hover:bg-blue-500/25 dark:hover:bg-blue-600/10' : 'hover:bg-white dark:hover:bg-gray-900/5' ]">
        <div class="text-center scale-100 group-hover:scale-125 transition h-12 md:h-16">
