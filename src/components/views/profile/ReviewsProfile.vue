...
import ReviewRecommendation from "@/components/views/profile/reviews/ReviewRecommendation.vue"
import ReviewRating from "@/components/views/profile/reviews/ReviewRating.vue"
      ...
      <div v-for="(review, key) in reviews" v-if="reviews.length" class="p-4 review">
        <div class="flex items-center gap-4">
          ...
          <div class="flex flex-col md:flex-row justify-between items-start">
            <div>
              <router-link :to="{ name: 'profile', params: { userId: review.author._id } }" class="font-medium hover:text-gray-900 dark:hover:text-gray-300 transition">
