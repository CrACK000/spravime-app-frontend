...
<template>
  <div class="relative bg-gradient-to-bl from-blue-600 to-indigo-500 dark:from-blue-600/75 dark:to-indigo-500/75 to-75% text-white md:rounded-3xl p-6 md:p-10 lg:p-14 xl:p-16 shadow-xl overflow-hidden">
