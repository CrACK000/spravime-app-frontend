...
<template>
  <div class="text-xl font-light mb-4 px-4 md:px-0 py-2">
    <div class="loading-bar h-4 max-w-full w-32 animate-pulse"></div>
  </div>
  <panel divide="y">
    <div v-for="key in props.rows" class="flex gap-4 p-5 animate-pulse" :key="key">
      <div>
