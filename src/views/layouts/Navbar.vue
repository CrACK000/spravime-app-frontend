<template>
  <div class="w-full md:w-11/12 lg:w-10/12 xl:w-9/12 2xl:w-9/12 mx-auto px-4 md:px-0 py-5 md:pt-14 md:pb-20 flex justify-between items-center">
    ...
    <div class="lg:flex items-center gap-3 hidden">
      ...
      <div v-for="link in links">
        <router-link :to="link.to" class="px-3 py-2 rounded-xl text-gray-500 dark:text-gray-400 hover:bg-white dark:hover:bg-gray-700 transition font-medium">{{ link.title }}</router-link>
      </div>
