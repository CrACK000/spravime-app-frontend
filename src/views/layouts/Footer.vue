  ...
  <div class="w-full md:w-11/12 lg:w-10/12 xl:w-9/12 2xl:w-9/12 mx-auto mt-auto">
    <panel class="mb-4 p-4">
      <div class="w-full mx-auto md:flex md:items-center md:justify-between">
        ...
        <button id="theme-toggle" type="button" class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none rounded-xl text-sm p-2.5 transition">
